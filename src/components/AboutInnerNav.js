  ...
  return (
    <div className="about-nav-container">
      ...
      <div className="who-we-are-text">
        <h1>Who We Are</h1>
        <p>
          Quality Equipment Rental LLC was founded in 2007. We deal in rental of
          various construction equipment. Our fleet covers wide range of
          equipment from Diesel Generators, Light Towers, Telescopic Handlers,
          Backhoe Loaders, Air Compressors, Rollers, Access Machines,Excavators,
          Motor Graders, Dozers and Forklifts.
        </p>
        <p>
          With our presence in Dubai, Abu Dhabi and Northern Emirates, we cover
          all parts of the UAE in supporting our customers for all their
